...
private:
	...
	void * m_pUniquenessMutex; /* Mutex used to ensure that multiple inserts/modifies that happen
...
private:
	...
	private:
		...
		HANDLE m_hMutex; /* controls acess to a datbase info, do not get while having the writer
	...
	public:
		...
		CSSM_RETURN GetDatabase(HANDLE &hMutex,DAL_DATABASE_INFO **dalDbInfo);
